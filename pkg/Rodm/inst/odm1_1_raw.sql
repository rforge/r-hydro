...
CREATE TABLE  Sites  (
	...
	LocalX  double  COMMENT 'Local Projection X coordinate.', 
	LocalY double COMMENT 'Local Projection Y Coordinate.', 
	...
	PosAccuracy_m  double COMMENT 'Value giving the accuracy with which the positional information is specified in meters.', 
