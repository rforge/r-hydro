...
void topmodel_topidx_calc(double *topidx, int nidxclass)
{
	int	i, j;
	double	x;
...
void topmodel_memory_allocation(int nch, int ntimestep, int nidxclass)
{
	int i;
...
void topmodel_memory_free(int nch, int ntimestep, int nidxclass)
{
	int i;
